...
export const fetchItems = createAsyncThunk('items/fetchItems', async () => {
    const response = await fetch(`${import.meta.env.VITE_FOS_CLIENT_API}/auth/freelancer`); // Replace with your API endpoint
    if (!response.ok) {
  ...
  export const { setRefresh } = FreelancerSlice.actions;
  // Export the reducer
