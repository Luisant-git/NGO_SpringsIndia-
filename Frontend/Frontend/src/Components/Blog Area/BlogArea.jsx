                    ...
                    <div className="row justify-content-center">
                            ...
                            <div className="jm-blog-item-3 mb-30">
                                <div className="jm-blog-item-img-3">
                                    <div className="jm-blog-item-img-inner-3 w_img">
                                        <Link to="/login"> <img src="assets/img/blog/4.jpg" alt="img"/></Link>
                                    </div>
                                ...
                                <div className="jm-blog-item-content-3">
                                    ...
                                    <div className="jm-blog-item-content-info-3">
                                        <h4 className="title"><Link to="/login">Hire the best freelancers for any job, online</Link></h4>
                                        {/* <div className="jm-blog-button mt-15">
                                            <Link to="/login" className="jm-blog-btn">Read More <i className="fa-thin fa-arrow-right-long"></i></Link>
                                        </div> */}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6">
                            <div className="jm-blog-item-3 mb-30">
                                <div className="jm-blog-item-img-3">
                                    <div className="jm-blog-item-img-inner-3 w_img">
                                        <Link to="/login"> <img src="assets/img/blog/5.jpg" alt="img"/></Link>
                                    </div>
                                    <div className="jm-blog-date-3">
                                        <h5>01</h5>
                                        <span>Jan</span>
                                ...
                                <div className="jm-blog-item-content-3">
                                    ...
                                    <div className="jm-blog-item-content-info-3">
                                        <h4 className="title"><Link to="/login">you gain skills you get more opportunity for job</Link></h4>
                                        {/* <div className="jm-blog-button mt-15">
                                            <Link to="/login" className="jm-blog-btn">Read More <i className="fa-thin fa-arrow-right-long"></i></Link>
                                        </div> */}
                                    </div>
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6">
                            <div className="jm-blog-item-3 mb-30">
                                <div className="jm-blog-item-img-3">
                                    <div className="jm-blog-item-img-inner-3 w_img">
                                        <Link to="/login"> <img src="assets/img/blog/6.jpg" alt="img"/></Link>
                                    </div>
                                    <div className="jm-blog-date-3">
                                        <h5>28</h5>
                                        <span>Sep</span>
                                ...
                                <div className="jm-blog-item-content-3">
                                    ...
                                    <div className="jm-blog-item-content-info-3">
                                        <h4 className="title"><Link to="/login">You Should Learn Advance level Wordpress for Job</Link></h4>
                                        {/* <div className="jm-blog-button mt-15">
                                            <Link to="/login" className="jm-blog-btn">Read More <i className="fa-thin fa-arrow-right-long"></i></Link>
                                        </div> */}
                                    </div>
