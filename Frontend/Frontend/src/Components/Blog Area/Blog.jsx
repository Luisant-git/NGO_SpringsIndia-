        ...
        <div className="container">
            ...
            <div className="row justify-content-center">
                <div className="col-xl-4 col-lg-4 col-md-6">
                    <div className="jm-blog-item jm-blog-layout-2 mb-55">
                        <div className="jm-blog-item-img w_img">
                            <Link to="/login"><img src="assets/img/blog/1.jpg" alt="Image Not Found"/></Link>
                        ...
                        <div className="jm-blog-item-content">
                            ...
                            <h4 className="jm-blog-title"><Link to="/login">How to Work Instagram Marketing</Link></h4>
                            <Link to="/login" className="read-more theme-btn-jm">Read More <i className="fa-thin fa-arrow-right-long"></i></Link>
                        </div>
                    </div>
                </div>
                <div className="col-xl-4 col-lg-4 col-md-6">
                    <div className="jm-blog-item jm-blog-layout-2 mb-55">
                        <div className="jm-blog-item-img w_img">
                            <Link to="/login"><img src="assets/img/blog/2.jpg" alt="Image Not Found"/></Link>
                            <div className="jm-blog-date">
                                <h6>23</h6>
                                <span>Aug</span>
                            </div>
                        ...
                        <div className="jm-blog-item-content">
                            ...
                            <h4 className="jm-blog-title"><Link to="/login">Businesses Thriving, Are Not Societies.</Link></h4>
                            <Link to="/login" className="read-more theme-btn-jm">Read More <i className="fa-thin fa-arrow-right-long"></i></Link>
                        </div>
                    </div>
                </div>
                <div className="col-xl-4 col-lg-4 col-md-6">
                    <div className="jm-blog-item jm-blog-layout-2 mb-55">
                        <div className="jm-blog-item-img w_img">
                            <Link to="/login"><img src="assets/img/blog/3.jpg" alt="Image Not Found"/></Link>
                            <div className="jm-blog-date">
                                <h6>23</h6>
                                <span>Aug</span>
                            </div>
                        ...
                        <div className="jm-blog-item-content">
                            ...
                            <h4 className="jm-blog-title"><Link to="/login">Nike Shoes Attract More For Sales</Link></h4>
                            <Link to="/login" className="read-more theme-btn-jm">Read More <i className="fa-thin fa-arrow-right-long"></i></Link>
                        </div>
                    </div>
                </div>
