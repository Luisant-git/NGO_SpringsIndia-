              ...
              <div className="grid gap-6">
                {year.impactMonths.map((month) => (
                  <div key={month.id} className="border border-gray-200 rounded-lg overflow-hidden">
                    <div className={month.images.length > 0 ? 'lg:flex' : ''}>
                      {month.images.length > 0 && (
                        <div className={month.images.length <= 3 ? 'lg:w-1/2' : 'lg:w-2/3'}>
                      ...
                      <div className={month.images.length === 0 ? 'p-6' : month.images.length <= 3 ? 'lg:w-1/2 p-6' : 'lg:w-1/3 p-6'}>
