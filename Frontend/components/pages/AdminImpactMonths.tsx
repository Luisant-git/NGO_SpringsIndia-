        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto relative">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                <label className="block text-sm font-medium text-gray-700 mb-2">Images (max 9)</label>
                ...
                {formData.images.length < 9 && (
                  <>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      {formData.images.length}/9 images uploaded. Can add {9 - formData.images.length} more.
                    </p>
                  </>
                )}
                
                {formData.images.length >= 9 && (
                  <p className="text-sm text-green-600">Maximum 9 images uploaded.</p>
                )}
              </div>
